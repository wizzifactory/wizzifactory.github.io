/*
    ...
    primary source IttfDocument: c:\my\wizzi\v3\apps\docs\legacy\ittf\wizzi-docs\site\wizzifactory.js.ittf
    utc time: Thu, 10 Aug 2017 13:11:03 GMT
*/
'use strict';
...
function setupClickHandler(ctx) {
    var chel = wzui.element('#main-content');
    wzui.click(chel, create_mainContentClickHandler(ctx));
}
function create_mainContentClickHandler(ctx) {
    return function mainContentClickHandler(event) {
            console.log('mainContentClickHandler.target', event.target, event.target.dataset);
